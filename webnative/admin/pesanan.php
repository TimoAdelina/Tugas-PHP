                ...
                <tr>
                    ...
                    <td>
                        <form action="pesanan_controller.php" method="POST">
                            ...
                            <a class="btn btn-warning btn-sm" href="index.php?url=pesanan_form&idedit=<?=$row['id']?>">
                                Ubah</a>
                            <button type="submit" class=" btn btn-danger btn-sm" name="prosess" value="hapus"
                                onclick="return confirm('anda yakin ingin dihapus')">Hapus</button>
